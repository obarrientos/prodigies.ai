...
import { initializeAuth, getAuth, getReactNativePersistence,createUserWithEmailAndPassword } from 'firebase/auth';
...
export { app, auth, getApp, getAuth, createUserWithEmailAndPassword  };
